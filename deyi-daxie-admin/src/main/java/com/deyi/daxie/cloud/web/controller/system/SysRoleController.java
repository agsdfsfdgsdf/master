...
public class SysRoleController extends BaseController
{
    ...
    @GetMapping("/list")
    @Log(title = "角色管理->获取角色列表", businessType = BusinessType.SEARCH)
    ...
    @Log(title = "角色管理->根据角色编号获取详细信息", businessType = BusinessType.SEARCH)
    ...
    @ApiOperation("删除角色")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "roleIds", value = "角色id", required = true, dataType = "Long[]")
    })
    ...
    @Log(title = "角色管理->获取角色选择框列表", businessType = BusinessType.SEARCH)
    ...
    @Log(title = "角色管理->查询已分配用户角色列表", businessType = BusinessType.SEARCH)
    ...
    @Log(title = "角色管理->查询未分配用户角色列表", businessType = BusinessType.SEARCH)
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "roleId", value = "角色id", required = true, dataType = "Long"),
            @ApiImplicitParam(name = "userIds", value = "用户id", required = true, dataType = "Long[]")
    })
    @PreAuthorize("@ss.hasPermi('system:role:edit')")
    @Log(title = "角色管理", businessType = BusinessType.GRANT)
