...
import com.deyi.daxie.cloud.system.domain.SysUserOnline;
import com.deyi.daxie.cloud.system.service.ISysUserOnlineService;
...
public class SysUserOnlineController extends BaseController
{
    ...
    @GetMapping("/list")
    @Log(title = "在线用户监控", businessType = BusinessType.SEARCH)
