...
import com.deyi.daxie.cloud.system.service.ISysPostService;
...
public class SysPostController extends BaseController
{
    ...
    @GetMapping("/list")
    @ApiOperation("岗位查询")
    @Log(title = "岗位管理->岗位查询", businessType = BusinessType.SEARCH)
    ...
    @Log(title = "岗位管理->根据岗位编号获取详细信息", businessType = BusinessType.SEARCH)
    ...
    @Log(title = "岗位管理->获取岗位选择框列表", businessType = BusinessType.SEARCH)
