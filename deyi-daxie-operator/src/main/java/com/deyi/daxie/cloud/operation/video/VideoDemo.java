...
import static com.deyi.daxie.cloud.operation.video.VideoController.hCNetSDK;
import static com.deyi.daxie.cloud.operation.video.VideoController.playControl;
...
//        }
    ...
    public static void getPicbyPlayCtrl() {
        ...
        try {
            ...
            fout = new FileOutputStream(System.getProperty("user.dir") + "//pic//" + newName + ".jpeg");
            //将字节写入文件
            long offset = 0;
    ...
    public void playBackBytime(int userID, int lChannel) {
        ...
        //开始时间
        net_dvr_vod_para.struBeginTime.dwYear = 2023;
        net_dvr_vod_para.struBeginTime.dwMonth = 10;
        net_dvr_vod_para.struBeginTime.dwDay = 20;
        net_dvr_vod_para.struBeginTime.dwHour = 14;
        net_dvr_vod_para.struBeginTime.dwMinute = 40;
        net_dvr_vod_para.struBeginTime.dwSecond = 00;
        //停止时间
        net_dvr_vod_para.struEndTime.dwYear = 2023;
        net_dvr_vod_para.struEndTime.dwMonth = 10;
    ...
    public static void downloadRecordByFile(int userID, int iChannelNo) {
        ...
        struFileCond.struStartTime.dwHour = 05;
        struFileCond.struStartTime.dwMinute = 00;
        struFileCond.struStartTime.dwSecond = 00;
        //停止时间
        struFileCond.struStopTime.dwYear = 2023;
        struFileCond.struStopTime.dwMonth = 12;
        struFileCond.struStopTime.dwDay = 05;
...
/*        IntByReference intP=new IntByReference(30*1024);
    ...
    //按时间下载录像(不支持转码3GP格式)
    public String dowmloadRecordByTime(int userID, HCNetSDK.NET_DVR_TIME startTime, HCNetSDK.NET_DVR_TIME endTime, int channel) {
       ...
       /* net_dvr_playcond.struStartTime.dwYear=2023;
        net_dvr_playcond.struStartTime.dwMonth=11;
        net_dvr_playcond.struStartTime.dwDay=29;
        net_dvr_playcond.struStartTime.dwHour=9;
        net_dvr_playcond.struStartTime.dwMinute=00;
        net_dvr_playcond.struStartTime.dwSecond=00;*/
        //停止时间
        net_dvr_playcond.struStopTime = endTime;
        /*net_dvr_playcond.struStopTime.dwYear=2023;
        net_dvr_playcond.struStopTime.dwMonth=11;
        net_dvr_playcond.struStopTime.dwDay=29;
        ...
        if (m_lLoadHandle >= 0) {
            ...
            IntByReference intInlen = new IntByReference(0);
            boolean b_PlayBack = hCNetSDK.NET_DVR_PlayBackControl_V40(m_lLoadHandle, 24, intP.getPointer(), 4, Pointer.NULL, intInlen);
            if (!b_PlayBack) {
                log.error("设置下载速度失败，错误码为" + hCNetSDK.NET_DVR_GetLastError());
            }
            ...
            log.error("laste error " + hCNetSDK.NET_DVR_GetLastError());
