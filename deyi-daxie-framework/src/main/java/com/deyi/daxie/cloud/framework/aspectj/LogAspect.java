package com.deyi.daxie.cloud.framework.aspectj;
...
import com.deyi.daxie.cloud.common.enums.BusinessStatus;
import com.deyi.daxie.cloud.common.enums.HttpMethod;
...
public class LogAspect
{
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult)
    {
        try
        {
            ...
            if(operLog.getBusinessType() != BusinessType.SEARCH.ordinal() && operLog.getBusinessType() != BusinessType.WS.ordinal() ){
                // 保存数据库
                AsyncManager.me().execute(AsyncFactory.recordOper(operLog));
            }
            log.info("LOG ==> {}", operLog);
        }
        catch (Exception exp)
        {
            // 记录本地异常日志
